...
module Chat.Capability.Now where
...
-- This class may seem trivial:
-- these are all functions available from the `purescript-now` package.
-- However, by making this pure, we can use it in tests deterministically.
-- This is especially useful for snapshot tests.
